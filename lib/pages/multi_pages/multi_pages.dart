                ...
                children: [
                  Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        backgroundColor: _movie ? Colors.black : Colors.red,
                        radius: 20,
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        backgroundColor: _aboutUs ? Colors.black : Colors.red,
                        radius: 20,
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        backgroundColor: _social ? Colors.black : Colors.red,
                        radius: 20,
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        backgroundColor: _login ? Colors.black : Colors.red,
                        radius: 20,
    ...
    return BottomNavigationBar(
      onTap: (int index) {
        setState(() {
          ...
          index == 0 ? movieCountClicked += 1 : movieCountClicked = 0;
          movieCountClicked == 2
              ? movieScreenKey.currentState.movieGotoTop()
              : null;
          movieCountClicked == 2 ? movieCountClicked -= 1 : null;

          index == 1 ? cinemaCountClicked += 1 : cinemaCountClicked = 0;
          cinemaCountClicked == 2
              ? cinemaScreenKey.currentState.cinemaGotoTop()
              : null;
