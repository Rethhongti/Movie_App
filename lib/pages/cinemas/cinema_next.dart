...
class _CinemaNextState extends State<CinemaNext> {
  ...
  get _buildBody {
    double subValue = AppBar().preferredSize.height +
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            BuildInsertPersonalInfo(
                nameController: nameController,
                phoneController: phoneController,
                selectPaymentController: selectPaymentController,
                subValue: subValue),
                          ...
                          actions: [
                            RaisedButton(
                              onPressed: () {
                                ...
                                setState(() {
                                  dropdownValue = null;
                                  buildDateTimePickerKey
                                      .currentState.datePicked = null;
                                  buildDateTimePickerKey
                                      .currentState.timePicked = null;
                                });
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          InkWell(
                            child:
                                Icon(Icons.timer, color: Colors.red, size: 32),
                            onTap: () {
                              showTimePicker(
                                  context: context,
